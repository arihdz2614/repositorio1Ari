...
deptno_fk FOREIGN KEY (deptno) REFERENCES dept (deptno),CONSTRAINT emp_mgr_fk FOREIGN KEYCREATE TABLE emp(empno NUMERIC(4) PRIMARY KEY,
...
comm NUMERIC(7,2),
deptno NUMERIC(2),
CONSTRAINT emp_deptno_detp_ (mgr) REFERENCES emp (empno));
CREATE TABLE emp(
...
sal NUMERIC(7,2) NOT NULL,
comm NUMERIC(7,2),
deptno NUMERIC(2),CONSTRAINT emp_deptno_detp_deptno_fk FOREIGN KEY (deptno) REFERENCES dept (deptno),CONSTRAINT emp_mgr_fk FOREIGN KEY (mgr) REFERENCES emp (empno));
Describe emp;
INSERT INTO emp
